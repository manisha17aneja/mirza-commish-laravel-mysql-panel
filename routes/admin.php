...
Route::group(['middleware' => ['admin']], function () {
    Route::prefix('admin')->group(function () {
        ...
        //Broker Expenses
        Route::prefix('broker-expenses')->group(function () {
            Route::get('/{id}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerExpList')->name('admin.brokerexp.list');
            Route::post('get-records/{id}', 'App\Http\Controllers\Admin\BrokerExpenseController@getRecords')->name('admin.brokerexp.getrecords');
            Route::get('add/{id}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpAdd')->name('admin.brokerexp.add');
            Route::post('post/{id}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpPost')->name('admin.brokerexp.post');
            Route::get('edit/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpEdit')->name('admin.brokerexp.edit');
            Route::post('edit_get/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpEditGet')->name('admin.brokerexp.edit');
            Route::get('view/{id}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpView')->name('admin.brokerexp.view');
            Route::post('update/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpUpdate')->name('admin.brokerexp.update');
            Route::get('delete/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerExpenseController@brokerexpDelete')->name('admin.brokerexp.delete');
        });

        //Broker Tasks
        Route::prefix('broker-tasks')->group(function () {
            Route::get('/{id}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerExpList')->name('admin.brokertsk.list');
            Route::post('get-records/{id}', 'App\Http\Controllers\Admin\BrokerTasksController@getRecords')->name('admin.brokertsk.getrecords');
            Route::get('add/{id}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerAdd')->name('admin.brokertsk.add');
            Route::post('post/{id}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerPost')->name('admin.brokertsk.post');
            Route::get('edit/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerEdit')->name('admin.brokertsk.edit');
            Route::post('edit_get/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerEditGet')->name('admin.brokertsk.edit_get');
            Route::get('view/{id}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerView')->name('admin.brokertsk.view');
            Route::post('update/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerTasksController@brokertskUpdate')->name('admin.brokertsk.update');
            Route::get('delete/{id}', 'App\Http\Controllers\Admin\BrokerTasksController@brokerDelete')->name('admin.brokertsk.delete');
        });
        ...
        Route::prefix('broker-certifications')->group(function () {
            Route::get('/{id}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerExpList')->name('admin.brokercert.list');
            Route::post('get-records/{id}', 'App\Http\Controllers\Admin\BrokerCertificationsController@getRecords')->name('admin.brokercert.getrecords');
            Route::get('add/{id}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerAdd')->name('admin.brokercert.add');
            Route::post('post/{id}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerPost')->name('admin.brokercert.post');
            Route::get('edit/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerEdit')->name('admin.brokercert.edit');
            Route::post('edit_get/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerEditGet')->name('admin.brokercert.edit_get');

            Route::get('view/{id}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerView')->name('admin.brokercert.view');
            Route::post('update/{id}/{bid}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokertskUpdate')->name('admin.brokercert.update');
            Route::get('delete/{id}', 'App\Http\Controllers\Admin\BrokerCertificationsController@brokerDelete')->name('admin.brokercert.delete');
        });
        ...
        Route::prefix('deals')->group(function () {
            ...
            Route::get('get-single-deal-commissions', 'App\Http\Controllers\Admin\DealsController@getSgDCommissions')
                 ->name('admin.deals.getcomdata');
        ...
        Route::prefix('deals-tasks')->group(function () {
            ...
            Route::post('get-record/{id}/{bid}', 'App\Http\Controllers\Admin\DealTasksController@brokergetRecord')
                ->name('admin.dealtsk.getRecord');
        ...
        //ContactRole
        Route::prefix('contactrole')->group(function () {
            Route::get('/', 'App\Http\Controllers\Admin\ContactRoleController@index')->name('admin.contactrole');
            Route::post('/get-records', 'App\Http\Controllers\Admin\ContactRoleController@getRecords')->name('admin.contactrole.getrecords');
            Route::post('post', 'App\Http\Controllers\Admin\ContactRoleController@saveData')->name('admin.contactrole.post');
            Route::post('get-record', 'App\Http\Controllers\Admin\ContactRoleController@getRecord')->name('admin.contactrole.getrecord');
            Route::post('update', 'App\Http\Controllers\Admin\ContactRoleController@updateData')->name('admin.contactrole.update');
            Route::post('delete', 'App\Http\Controllers\Admin\ContactRoleController@deleteData')->name('admin.contactrole.delete');
        });
//ContactRole
        ...
        Route::prefix('lenders-commission-schedules')->group(function () {
            ...
            Route::post('get-single-commission', 'App\Http\Controllers\Admin\LenderCommissionSchedulesController@getSgCommission')
                 ->name('admin.lendercommissionschedule.getsingle');
        });
        ...
        Route::prefix('reports')->group(function () {
            ...
            ////////////////Clients//////////////////////////////////
                ...
                Route::post('/export-pipeline-records',
            ...
            Route::prefix('broker')->group(function () {
                ...
                Route::post('/export-broker-invoice',
            ...
            Route::prefix('lender')->group(function () {
                ...
                //////////////////////////////////////////////////////////////////
                Route::post('/get-trail-commission-not-received',
                ...
                Route::post('/export-trail-commission-not-received',
                    ...
                    //////////////////////////////////////////////////////////////////
                Route::post('/get-upfront-commission-not-received',
                ...
                Route::post('/export-upfront-commission-not-received',
            ...
            Route::prefix('referrer')->group(function () {
                Route::get('/', [\App\Http\Controllers\Admin\Reports\ReferrerReportsController::class, 'index'])
                    ->name('admin.referrer.index');
            });
        });
    });
});
