...
<body style=" font-family: system-ui, system-ui, sans-serif;">
    ...
    <table style="margin-top: 5px;margin-bottom:5px;width: 100%">
        <tbody>
        <tr>
            <td style="width: 25%"> <span style="font-size: 18px;font-weight: bold;">FM Direct Pipeline</span></td>
    ...
    @foreach($deals as $deal)
        ...
        $deals_list=$deals_list->whereIn('status',[1,2,3,4,5])->get();
            ...
            @foreach($deals_list as $deal_list)
                <tr>
                    ...
                    <td><?php
                        ...
                        ?></td>
                    <td>{{ $deal_list->deal_status->name??$deal_list->status }}</td>
