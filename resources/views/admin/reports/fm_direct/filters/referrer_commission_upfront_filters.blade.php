<form method="POST" id="referrer_commission_upfront" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#referrer_commission_upfront").attr("action","{{ route("admin.fm_direct.get_referrer_commission_upfront") }}");
            $("#referrer_commission_upfront").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#referrer_commission_upfront").attr("action","{{ route("admin.fm_direct.export_referrer_commission_upfront") }}");
            $("#referrer_commission_upfront").submit();
        });
    </script>
