...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#monthly_pipeline_form").attr("action","{{ route("admin.fm_direct.get_deals_to_track") }}");
            $("#monthly_pipeline_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#monthly_pipeline_form").attr("action","{{ route("admin.fm_direct.export_deals_to_track") }}");
            $("#monthly_pipeline_form").submit();
        });
    </script>
