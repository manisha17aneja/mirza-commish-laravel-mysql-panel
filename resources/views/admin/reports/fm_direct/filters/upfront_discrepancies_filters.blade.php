<form method="POST" id="upfront_discrepancies" target="_blank">
    @csrf
    ...
    <div class="row">
        ...
        <div class="col-md-6 col-sm-12">
            <div class="form-group">
                ...
                <input name="variance" id="variance" type="text" value="0" class=" form-control" required>
            </div>
        </div>
    </div>
    <div class="row">
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#upfront_discrepancies").attr("action","{{ route("admin.fm_direct.get_upfront_discrepancies") }}");
            $("#upfront_discrepancies").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#upfront_discrepancies").attr("action","{{ route("admin.fm_direct.export_upfront_discrepancies") }}");
            $("#upfront_discrepancies").submit();
        });
    </script>
