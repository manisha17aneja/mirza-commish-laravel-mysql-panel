<form method="POST" id="birthday_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#birthday_form").attr("action","{{ route("admin.fm_direct.get_birthday_records") }}");
            $("#birthday_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#birthday_form").attr("action","{{ route("admin.fm_direct.export_birthday_record") }}");
            $("#birthday_form").submit();
        });
    </script>
