<form method="POST" id="commission_ranking" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#commission_ranking").attr("action","{{ route("admin.fm_direct.get_commission_ranking") }}");
            $("#commission_ranking").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#commission_ranking").attr("action","{{ route("admin.fm_direct.export_commission_ranking") }}");
            $("#commission_ranking").submit();
        });
    </script>
