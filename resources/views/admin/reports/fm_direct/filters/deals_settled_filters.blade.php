<form method="POST" id="deals_settled_form" target="_blank">
    @csrf
    ...
    <script>
        ...
        $(".preview").on("click",function (){
           $("#deals_settled_form").attr("action","{{ route("admin.fm_direct.get_deal_settled_records") }}");
            $("#deals_settled_form").submit();
        });
        $(".export_pdf").on("click",function (){
           $("#deals_settled_form").attr("action","{{ route("admin.fm_direct.export_deal_settled_records") }}");
            $("#deals_settled_form").submit();
        });
    </script>
