<form method="POST" id="deal_tasks_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#deal_tasks_form").attr("action","{{ route("admin.fm_direct.get_deal_tasks_records") }}");
            $("#deal_tasks_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#deal_tasks_form").attr("action","{{ route("admin.fm_direct.export_deal_tasks_records") }}");
            $("#deal_tasks_form").submit();
        });
    </script>
