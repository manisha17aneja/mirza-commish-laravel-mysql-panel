<form method="POST" id="sales_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#sales_form").attr("action","{{ route("admin.fm_direct.get_sales") }}");
            $("#sales_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#sales_form").attr("action","{{ route("admin.fm_direct.export_sales") }}");
            $("#sales_form").submit();
        });
    </script>
