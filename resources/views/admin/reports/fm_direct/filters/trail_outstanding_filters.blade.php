<form method="POST" id="trail_outstanding_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#trail_outstanding_form").attr("action","{{ route("admin.fm_direct.preview_trail_outstanding") }}");
            $("#trail_outstanding_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#trail_outstanding_form").attr("action","{{ route("admin.fm_direct.export_trail_outstanding_records") }}");
            $("#trail_outstanding_form").submit();
        });
    </script>
