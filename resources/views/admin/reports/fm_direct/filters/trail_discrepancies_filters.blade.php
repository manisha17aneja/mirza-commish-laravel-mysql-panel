<form method="POST" id="trail_discrepancies" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#trail_discrepancies").attr("action","{{ route("admin.fm_direct.get_trail_discrepancies") }}");
            $("#trail_discrepancies").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#trail_discrepancies").attr("action","{{ route("admin.fm_direct.export_trail_discrepancies") }}");
            $("#trail_discrepancies").submit();
        });
    </script>
