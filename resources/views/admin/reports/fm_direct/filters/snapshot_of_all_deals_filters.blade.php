<form method="POST" id="snapshot_of_all_deals" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#snapshot_of_all_deals").attr("action","{{ route("admin.fm_direct.get_snapshot_of_all_deals") }}");
            $("#snapshot_of_all_deals").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#snapshot_of_all_deals").attr("action","{{ route("admin.fm_direct.export_snapshot_of_all_deals") }}");
            $("#snapshot_of_all_deals").submit();
        });
    </script>
