<form method="POST" id="upfront_outstanding_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#upfront_outstanding_form").attr("action","{{ route("admin.fm_direct.preview_upfront_outstanding") }}");
            $("#upfront_outstanding_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#upfront_outstanding_form").attr("action","{{ route("admin.fm_direct.export_upfront_outstanding_records") }}");
            $("#upfront_outstanding_form").submit();
        });
    </script>
