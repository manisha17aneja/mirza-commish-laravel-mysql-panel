<form method="POST" id="client_form" target="_blank">
    @csrf
...
@section('scripts')
    ...
    <script>
        ...
        $(".preview").on("click",function (){
            $("#client_form").attr("action","{{ route("admin.fm_direct.get_client_records") }}");
            $("#client_form").submit();
        });
        $(".export_pdf").on("click",function (){
            $("#client_form").attr("action","{{ route("admin.fm_direct.export_client_records") }}");
            $("#client_form").submit();
        });
    </script>
