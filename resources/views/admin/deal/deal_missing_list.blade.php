            ...
            <div class="col-sm-12">
                <div class="">
                    <table style="width: 100%"  id="TableData" class="table table-hover table-striped table-bordered"
                           data-toggle="table" data-height="500" data-show-columns="true" data-sAjaxSource="{{ route('admin.deals.getdealMissingRecords') }}"
                           data-aoColumns='{"mData": "Index no"},{"mData": "Loan Ref"},{"mData": "Added On"},{"mData": "Modified On"}'>
                        <thead>
                        <tr>
                            <th class="no-sort">#</th>
                            <th class="noVis">Loan Ref</th>
                            <th class="noVis">Added On</th>
                            <th class="noshow">Modified On</th>
