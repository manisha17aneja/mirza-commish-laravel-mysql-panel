...
@section('title')
    @if(isset($contact) && !empty($contact))
        Edit Referror::{{$contact->preferred_name}}
    @else
        Add Referror
    @endif
@endsection
@section('page_title_con')
    ...
    <div class="page-header">
        <div class="page-leftheader">
            <h4 class="page-title">
                @if(isset($contact) && !empty($contact))
                    Edit Referrer::{{$contact->preferred_name}}
                @else
                    Add
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" placeholder="Unit/Level/Street"
                                                                   ...
                                                                   value="{{isset($contact)?$contact->street_number:''}}"
                                                                   class="form-control"
                                                                   maxlength="250"/>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" placeholder="Street name"
                                                                   ...
                                                                   value="{{isset($contact)?$contact->street_name:''}}"
                                                                   class="form-control"
                                                                   maxlength="250"/>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" placeholder="Street type"
                                                                   ...
                                                                   value="{{isset($contact)?$contact->street_type:''}}"
                                                                   class="form-control"
                                                                   maxlength="250"/>
                                                        </div>
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input type="text" placeholder="City" name="suburb"
                                                                   ...
                                                                   value="{{isset($contact)?$contact->suburb:''}}"
                                                                   maxlength="250"/>
                                                        </div>
                                                            ...
                                                            <select name="state" id="state"
                                                                ...
                                                                @if(count($states)>0)
                                                                    @foreach($states as $state)
                                                                        <option value="{{$state->id}}" {{isset($contact) && $contact->state ==
                                                    ...
                                                    <div class="col-md-4 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            <input id="postal_code" name="postal_code"
                                                                   value="{{isset($contact)?$contact->postal_code:""}}"
                                                ...
                                                <div class="form-row">
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            @if($errors->has('acc_name'))
                                                                <div class="error"
                                                                     style="color:red">{{$errors->first('acc_name')}}</div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            @if($errors->has('bsb'))
                                                                <div class="error"
                                                                     style="color:red">{{$errors->first('bsb')}}</div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                    ...
                                                    <div class="col-md-3 col-sm-12">
                                                        <div class="position-relative form-group">
                                                            ...
                                                            @if($errors->has('acc_no'))
                                                                <div class="error"
                                                                     style="color:red">{{$errors->first('acc_no')}}</div>
                                                            @endif
                                                        </div>
                                                    </div>
                                                                ...
                                                                0)
                                                                    @foreach($broker->referrors as $tkey => $tval)
                                                                        <tr id="task_rw_{{$tkey}}">
                                                                            ...
                                                                            <td><select name="referrors[{{$tkey}}][referrer_id]"
                                                ...
                                                <div class="col-sm-12 mb-5">
                                                    <div class="float-right">
                                                        <button type="button" class="btn btn-primary" id="add_new_referror"
                                                                onclick="addNewReferror(this)">Add More
                                                        </button>
                                                    </div>
                                                </div>
                                            </div>
    ...
    <script>
        ...
        function addNewRelation(current) {
            var htmlCon = '<div class="col-sm-12" id="rel_' + rel_counter + '"><div class="row"><div class="col-sm-4"><div ' +
                ...
                'class="form-control"><option value="">Select Relation</option>' + relationstring + '</select></div></div><div ' +
                ...
                '_mailout"></div></div><div class="col-sm-2"><button type="button" class="btn btn-danger" onclick="removerelation (this)" data-id="' + rel_counter + '"><i class="fa fa-trash"></i> ' +
                '</button></div></div></div>';
        ...
        function addNewReferror(current) {
            var task_tr = '<tr id="task_rw_'+task_counter+'"> <td><select name="referrors['+task_counter+'][referrer_id]" ' +
