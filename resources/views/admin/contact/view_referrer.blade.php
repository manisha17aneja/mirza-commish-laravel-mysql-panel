...
<div class="page-header">
    <div class="page-leftheader">
        <h4 class="page-title">
            View Referrer::{{$contact->preferred_name}} <a class="btn
                   ...
                   <div class="col-sm-12">
                       <div class="row">
                           ...
                           <div class="col-sm-3">
                             <div class="card">
                                 <div class="card-body">
                                     <p class="mb-2"><b>Broker : </b><a class="active_a" href="{{route('admin.brokers.view',encrypt($contact->contact_abp_id))}}" target="_blank">{{$contact->entity_name}}</a></p>
                ...
                <div class="row">
                    <div class="col-sm-12">
                        <div class="card">
                            ...
                            <div class="card-header">
                                <button type="button" class="btn btn-primary float-right" onclick="return showAddTasks()">Add Task</button>
                            </div>
                  ...
                  <div class="col-sm-12">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <form method="post"
                            action="{{isset($taskdata)?route('admin.referrercom.update', [encrypt
                            ($taskdata->id),
                            encrypt($contact->id)]):route('admin.referrercom.post',encrypt($contact->id))}}" id="commission_model_form" onsubmit="return saveCommissionModelForm(this)">
                          @csrf
                          @if ($errors->any())
                                  ...
                                  <div class="col-sm-3">
                                   ...
                                   <div class="col-sm-3">
                                      <div class="position-relative form-group">
                                          ...
                                          text-lowercase number-input" data-max="100" data-min="0" placeholder="Upfront" required  value="{{$contact->upfront_per}}">
                                   ...
                                   <div class="col-sm-3">
                                      <div class="position-relative form-group">
                                          ...
                                          text-lowercase number-input" data-max="100" data-min="0" placeholder="Trail" required value="{{$contact->trail_per}}">
                                   ...
                                   <div class="col-sm-3">
                                      <div class="position-relative form-group">
                                          ...
                                          text-lowercase number-input" placeholder="Flat Fee Chrg" required value="{{$contact->flat_fee_chrg}}">
                              ...
                              <table class="mb-0 table table-bordered">
                                      ...
                                      <tbody>
                                           @foreach($institutes as $key => $institute)
                                              <tr><?php 
                                              $rcmi = DB::table('referrer_commission_model_institution')->where('referrer_com_mo_inst_id', $contact->rcomid)->where('lender_id', $institute->id)->first();
                                              //print_R($rcmi->upfront);
                                              ?>
                                                  <td>{{ ($key + 1) }}</td>
                                                  <td>{{($institute->name != '') ? $institute->name : $institute->code}}</td>
                                                  <td><input type="hidden" name="institutes_model[{{$institute->id}}][id]" value="{{ $institute->id }}" class="form-control" data-max="100" /><input type="text" class="form-control upfront_amnt number-input" placeholder="Upfront" data-max="100" name="institutes_model[{{$institute->id}}][upfront]" id="institutes_model_{{$institute->id}}_upfront" value="{{ isset($rcmi->upfront) ? $rcmi->upfront : '' }}" /></td>
                                                  <td><input type="text" class="form-control trail_amnt number-input" data-max="100" name="institutes_model[{{$institute->id}}][trail]" id="institutes_model_{{$institute->id}}_trail" placeholder="Trail" value="{{ isset($rcmi->trail) ? $rcmi->trail : '' }}" /></td>
                                              </tr>
                                          @endforeach
                                      </tbody>
                              </table>
