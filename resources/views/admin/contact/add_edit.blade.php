                                                ...
                                                <div class="col-sm-4">
                                                    <div class="form-group">
                                                        ...
                                                        <select name="referrer_type"
                                                            ...
                                                            <option {{  isset($contact) &&$contact->referrer_type==2?'selected':'' }} value="2">Existing Client</option>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <select name="other_referrer" id="other_referrer"
                                                            ...
                                                            @foreach($refferors as $refferor)
                                                                <option value="{{$refferor->id}}" {{(isset($contact) &&
                                                                    $contact->other_referrer !='' &&
                                                                    $contact->other_referrer == $refferor->id )
                                                                    ? 'selected="selected"' : ''}}>
                                                                    {{$refferor->first_name.' '.$refferor->surname}}</option>
                                                            @endforeach
                                                        </select>
                                                    </div>
                                                </div>
