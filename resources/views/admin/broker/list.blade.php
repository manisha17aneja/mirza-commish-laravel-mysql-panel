                    ...
                    <form method="get">
                        <div class="row mb-1">
                            ...
                            <div class="col-md-3 col-sm-12">
                                ...
                                <input name="trading" value="" id="trading" type="text" placeholder="Trading/Business"
                                       class="form-control">
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                                        ...
                                        @if(count($cities)>0)
                                            @foreach($cities as $city)
                                                <option value="{{$city->id}}"
                                                        data-state_id="{{$city->state_id}}" >{{$city->name}}</option>
                                            @endforeach
                                        @endif
                                    </select>
                            ...
                            <div class="col-md-2 col-sm-12">
                                <div class="form-group">
                                    ...
                                    <input name="id" value="" id="id" placeholder="ID"
                                           type="number" class="form-control input_int_number">
                                </div>
                ...
                <div class="card-body">
                    ...
                    <div class="table-responsive">
                        ...
                        table-bordered display nowrap"
                               data-toggle="table" data-height="500" data-show-columns="true" data-sAjaxSource="{{ route('admin.brokers.getrecords') }}"
