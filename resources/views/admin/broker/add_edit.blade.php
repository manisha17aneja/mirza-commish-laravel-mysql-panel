...
<div class="page-header">
    ...
    <div class="page-rightheader ml-auto d-lg-flex d-none">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page"> @if(isset($broker) && !empty($broker))
                Edit Broker::{{$broker->given_name}}
                @else
                Add Broker
                @endif
                        ...
                        <div class="tab-menu-heading">
                            <div class="tabs-menu ">
                                ...
                                <ul class="body-tabs body-tabs-layout tabs-animated body-tabs-animated nav panel-tabs">
                                    <li class="nav-item">
                                        <a role="tab" class="nav-link nav-link-0 active" id="tab-0" data-toggle="tab"
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-group">
                                                        ...
                                                        <select name="search_for" id="search_for" class="form-control"
                                                            onchange="javascript:Searchtype(this);" required>
                                                            <option value="">Choose Type</option>
                                                            @foreach($types as $type)
                                                            <option value="{{$type->id}}"
                                                                {{(isset($broker) && $broker->parent_broker == 0)?'selected':''}}
                                                                data-value="">{{$type->name}}</option>
                                                            @endforeach
                                                            <option value="1"
                                                                {{(isset($broker) && $broker->parent_broker > 0)?'selected':''}}data-value="broker_staff">
                                                                Broker Staff</option>
                                                        </select>
                                                ...
                                                <div class="col-md-4 col-sm-12">
                                                    <div class="position-relative form-check form-check-inline">
                                                        ...
                                                        <label class="custom-switch" style="margin-top: 30px">
                                                            <input value="1" id="is_active" @if(!isset($broker) || (isset($broker) && $broker->is_bdm == 1))
                                                            checked
                                                                   @endif name="is_active" type="checkbox" class="custom-switch-input">
                                                            <span class="custom-switch-indicator"></span>
                                                            <span class="custom-switch-description"> Is Active?</span>
                                                        </label>
                                                        @if($errors->has('is_active'))
                                                            <div class="error" style="color:red">{{$errors->first('is_active')}}</div>
                                                        @endif
                                                    </div>
                                                </div>
                                    ...
                                    <div class="col-md-4 col-sm-12">
                                        <div class="position-relative form-group">
                                            ...
                                            <select name="city" id="city" class="multiselect-dropdown">
                                                ...
                                                <option value="{{$city->id}}" data-state_id="{{$city->state_id}}" {{isset
                                                                        ($broker) && $broker->city ==
                        ...
                        <div class="card mb-2">
                            ...
                            <div class="card-body">
                                <div class="form-row">
                                   ...
                                   <!-- <div class="col-md-4 col-sm-12">
                                        <div class="position-relative form-group">
                                            <label class="form-label font-weight-bold">BDM</label>
                                            <select name="bdm" id="bdm" class="form-control">
                                                <option value="">Select BDM</option>
                                                @foreach($bdms as $bdm)
                                                <option value="{{$bdm->id}}" {{isset($broker) &&
                                                                    $broker->bdm == $bdm->id
                                                                    ? 'selected="selected"' : ''}}>
                                                    {{$bdm->display_name}}</option>
                                                @endforeach
                                            </select>

                                            @if($errors->has('bdm'))
                                            <div class="error" style="color:red">{{$errors->first('bdm')}}</div>
                                            @endif
                                        </div>
                                    </div>
                                    <div class="col-md-4 col-sm-12">
                                        <div class="position-relative form-check form-check-inline">
                                            ...
                                            <label class="custom-switch" style="margin-top: 30px">
                                                <input value="1" id="is_bdm" @if(isset($broker) && $broker->is_bdm == 1)
                                                checked
                                                @endif name="is_bdm" type="checkbox" class="custom-switch-input">
                                                <span class="custom-switch-indicator"></span>
                                                <span class="custom-switch-description"> Is BDM?</span>
                                            </label>
                                            @if($errors->has('is_bdm'))
                                            <div class="error" style="color:red">{{$errors->first('is_bdm')}}</div>
                                            @endif
                                        </div>
                                    </div>-->
                                    <div class="col-md-4 col-sm-12">
    ...
    <div class="clearfix">
        {{--<button type="button" id="reset-btn" class="btn-shadow float-left btn btn-link">Reset
           ...
           <button type="button" id=""
                                    class="btn-shadow btn-wide float-right btn-pill btn-hover-shine btn btn-primary" onclick="return previousnext(1)">
                                Next
                            </button>
        <button type="submit" id="finish-btn" class="btn-shadow float-right btn-wide btn-pill mr-3 btn btn-success">
            Finish
        </button>
           <button type="button" id=""
