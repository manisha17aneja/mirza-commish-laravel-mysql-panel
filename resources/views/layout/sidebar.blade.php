...
<div class="app-sidebar app-sidebar2">
    <div class="app-sidebar__logo">
        <a class="header-brand" href="{{route('admin.dashboard')}}">
            ...
            <img src="{{url('assets/images/logo-commish.png')}}" class="header-brand-img dark-logo" alt="Commish logo">
            <img src="{{url('assets/images/commish-favicon.png')}}" class="header-brand-img mobile-logo" alt="Commish logo">
            <img src="{{url('assets/images/commish-favicon.png')}}" class="header-brand-img darkmobile-logo" alt="Commish logo">
        </a>
    </div>
</div>
        ...
        <div class="dropdown user-pro-body text-center">
            <div class="user-pic">
                @if (auth()->user()->image && \Storage::disk('public')->exists('profile/images/' . auth()->user()->image))
                    <img src="{{asset('/storage/app/public/profile/images/'.auth()->user()->image)}}" alt="user-img" class="avatar-xl rounded-circle mb-1">
                @else
                    <img src="{{url('assets/images/users/16.jpg')}}" alt="user-img" class="avatar-xl rounded-circle mb-1">
                @endif
            </div>
            <div class="user-info">
        ...
        $module_permissions) || in_array('commission-types',$module_permissions) ))
            ...
            ->segment(2) == "products" || request()->segment(2) == "industry" || request()->segment(2) == "lenders" || request()->segment(2) == "expensetype" || request()->segment(2) == "service" ||request()->segment(2) == "referral" || request()->segment(2) == "processor"  || request()->segment(2) == "commission-types"  || request()->segment(2) == "commissions"  || request()->segment(2) == "refferor-commission-schedules"  ) ? 'mm-active':""}}">
                ...
                <ul class="slide-menu {{(request()->segment(2) == "abp" ) ? 'mm-show':""}}">
                    ...
                    @if($user_is_admin == 1 || (in_array('contact-role',$module_permissions)))
                        <li>
                            <a href="{{route('admin.contactrole')}}" class="slide-item {{request()->segment(2) ==
                            "contactrole" ? 'mm-active':""}}">
                                <i class="metismenu-icon"></i>
                                Contact Role
                            </a>
                        </li>
                    ...
                    @endif
                    <!--@if($user_is_admin == 1 || (in_array('processors',$module_permissions)))
                        <li>
                            <a href="{{route('admin.processor')}}" class="slide-item {{request()->segment(2) ==
                            "processor" ? 'mm-active':""}}">
                                <i class="metismenu-icon"></i>
                                Processors
                            </a>
        ...
        <li class="slide {{(request()->segment(2) == "reports")  ? 'mm-active':""}}">
            ...
            <ul class="slide-menu {{request()->segment(2) == "reports" ? 'mm-show':""}}">
                @if($user_is_admin == 1 || in_array('reports',$module_permissions))
                  {{--  <li>
                        <a href="{{ route('admin.bdm.index') }}" class="slide-item {{request()->segment(3) ==  "bdm" ? 'mm-active':""}}">
                            <i class="metismenu-icon"></i>
                            BDM
                        </a>
                    </li>--}}
                   ...
                   {{-- <li>
                        <a href="{{ route('admin.referrer.index') }}" class="slide-item {{request()->segment(3) ==  "referrer" ? 'mm-active':""}}">
                            <i class="metismenu-icon"></i>
                            Referrer
                        </a>
                    </li>--}}
