...
function refreshdataTable(customArgs, ModuleCallback,fnRowCallback) {
    if (typeof dataTable != 'undefined' && typeof dataTable == 'object') //&& dataTable instanceof $.fn.dataTable.Api
    {
        dataTable.destroy();
    }
    if (jQuery('#TableData').length > 0) {
        ...
        var aoColumns = jQuery('#TableData').attr('data-aoColumns');
        if(typeof aoColumns == 'undefined' || aoColumns == '') {

            jQuery('#TableData thead th').each(function (key, value) {
        ...
        var allowexport = jQuery('#TableData').attr('data-allowexport');
        var allowCardView = jQuery('#TableData').attr('data-allowcardview');
        var dtOrientation = jQuery('#TableData').attr('data-orientation');
        var dtPageSize = jQuery('#TableData').attr('data-pagesize');
        var keys = jQuery('#TableData').attr('data-keys');
        var initcallback = jQuery('#TableData').attr('data-initcallback');
        ...
        dataTable = jQuery('#TableData').DataTable({
